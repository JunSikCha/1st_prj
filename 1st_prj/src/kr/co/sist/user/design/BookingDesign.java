...
public class BookingDesign extends JFrame {
	...
	public BookingDesign(ClientMainDesign cmd) {
		this.cmd = cmd;
		...
		// JTextArea에 두꺼운 테두리 설정
		jtaDetail.setBorder(new LineBorder(Color.BLACK, 1)); // 검은색 두께 1의 테두리 설정
		...
		jlTitle.setBounds(150, 12, 200, 50);
		jlBranch.setBounds(90, 30, 100, 100);
		jcbBranch.setBounds(90, 100, 200, 30);
		jlBookdate.setBounds(90, 110, 100, 100);
		jcbBookYear.setBounds(90, 180, 80, 30);
		jcbBookMonth.setBounds(180, 180, 50, 30);
		jcbBookDay.setBounds(240, 180, 50, 30);
		jlBookTime.setBounds(90, 220, 200, 30);
		jcbBookTime.setBounds(90, 250, 200, 30);
		jlDetail.setBounds(90, 290, 200, 50);
		jtaDetail.setBounds(90, 330, 200, 50);
		jbtComplete.setBounds(80, 410, 100, 40);
		jbtCancel.setBounds(210, 410, 100, 40);
		...
		setBounds(cmd.getX() + 300, cmd.getY() + 30, 400, 500);
		setVisible(true);
