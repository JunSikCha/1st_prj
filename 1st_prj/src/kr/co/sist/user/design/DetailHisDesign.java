...
import kr.co.sist.user.event.DetailHisEvt;

public class DetailHisDesign extends JDialog {

	
	private HistoryDesign hd;
	private DetailHisEvt dhEvt;
...
//	public DetailHisDesign(HistoryDesign hd, String str) {
	public DetailHisDesign(HistoryDesign hd, String str) {
		super(hd, str, true);
...
//		jbPartRemove = new JButton("제거");
		...
		jbCancel = new JButton("취소"); // 맞나??



		// SubWindow이벤트 실행
//		CarManagerSubWindowEvt cmswe = new CarManagerSubWindowEvt(this.hd, this, str);
...
//		jpPartName.setBounds(50, 360, 145, 30);
		...
		scrollPane.setBounds(50, 260, 580, 160);
...
//		jbPartRemove.setBounds(570, 360, 60, 30);
		...
		jbtOk.setBounds(180, 510, 120, 30);
		jbCancel.setBounds(380, 510, 120, 30);

		dhEvt = new DetailHisEvt(this.hd,this);
		
//		setBounds(hd.getX() + 520, hd.getY() + 190, 700, 600);
		setBounds(520, 190, 700, 600);
