...
public class BookingManagerDAO {
	...
	public List<BookingManagerVO> selectBooking(String strDate, String endDate, String status, String certerNo,
			String isnull) throws SQLException {
		...
		try {
			...
			sb.append(
					"		select  booking_no, to_char(booking_date,'yyyy-mm-dd HH:mi') booking_date, ci.mname,issue,  bstatus, ui.user_id, ui.user_name, reason	")
			...
			sb.append("		order by booking_no desc	");
